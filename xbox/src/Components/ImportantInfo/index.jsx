    ...
    return (
        <div className='importantInfoSection'>
            ...
            <div className='col-2R'>
                ...
                <h3 class="underline-hover">Wireless Freedom and Versatility</h3>
                <h3 class="underline-hover">Quality at its Core</h3>
                <h3 class="underline-hover">Intuitive and Easy to Use</h3>
                <h3 class="underline-hover">Ergonomic Excellence</h3>
            </div>
        </div>
    );
}